            ...
            <CardContent className="p-8">
              ...
              <div className="grid md:grid-cols-4 gap-6 text-center">
                ...
                <div className="bg-white/50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-muted-foreground">7 seviyeye kadar dağıtım</p>
                </div>
                <div className="bg-white/50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-muted-foreground">Gönül ağında pasif kazanç</p>
                </div>
                <div className="bg-white/50 rounded-lg p-4">
